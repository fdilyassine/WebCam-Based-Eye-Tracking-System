...
![Tensorflow](https://img.shields.io/badge/tensorflow-v2.11.0-green.svg?style=plastic)
...
image_output_name = 'output.png' # replace with the name of the output image 
try : 
      img = Image.open("test_images/" + image_output_name)
      display(img)
except:
      print('Wrong name')  
